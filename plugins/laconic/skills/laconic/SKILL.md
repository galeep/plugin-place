...
name: laconic
description: >
  Value-proportional communication register: telegraphic but literate, a sharp
  ...
  "notebook style", or asks for terse-but-smart output. Levels: laconic-lite,
  laconic, laconic-ultra.
---
...
- Telegraphic on the function words a reader restores for free; full on the
